  ...
  reports: {
    ...
    yearSummary: {
      ...
      maintStatus: {
        ...
        approved: 'Đã duyệt',
        approved_by_head: 'Đã duyệt cấp 1',
        approved_by_admin: 'Đã duyệt cấp 2',
        approved_by_director: 'Đã duyệt cấp 3',
        in_progress: 'Đang thực hiện',
        repair_completed: 'Sửa xong, chờ duyệt',
        repair_approved: 'Đã duyệt hoàn thành sửa',
        completed: 'Hoàn thành',
        rejected: 'Từ chối',
        rejected_by_head: 'Từ chối cấp 1',
        rejected_by_admin: 'Từ chối cấp 2',
        rejected_by_director: 'Từ chối cấp 3',
