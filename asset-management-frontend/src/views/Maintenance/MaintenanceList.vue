    ...
    <el-card>
      ...
      <div class="filter-section">
        <el-row :gutter="16">
          ...
          <el-col :span="5">
            <el-select v-model="filterUrgency" :placeholder="$t('maintenance.filterByUrgency')" clearable @change="handleFilter">
      ...
      <div class="responsive-table">
        <el-table :data="maintenanceStore.requests" v-loading="maintenanceStore.loading" border stripe>
        <el-table-column type="index" width="50" label="#" />
        <el-table-column prop="asset.asset_code" :label="$t('maintenance.assetCode')" width="120" />
        <el-table-column prop="asset.name" :label="$t('maintenance.assetName')" min-width="180" />
        <el-table-column prop="description" :label="$t('maintenance.description')" min-width="200" show-overflow-tooltip />
        <el-table-column prop="urgency" :label="$t('maintenance.urgency')" width="120">
        ...
        <el-table-column prop="cost" :label="$t('maintenance.cost')" width="120">
          <template #default="{ row }">
            {{ row.cost ? formatCurrency(row.cost) : '-' }}
          </template>
        </el-table-column>
        <el-table-column prop="created_at" :label="$t('common.createdAt')" width="140">
          <template #default="{ row }">
